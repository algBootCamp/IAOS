...
(
    ...
    benchmark_total_return  double                               not null default 0.0 comment '对标基准累积收益',
    benchmark_annual_return double                               not null default 0.0 comment '对标基准年化平均收益',
    win_total_return        double                               not null default 0.0 comment '因子赢家组合累积收益',
    win_annual_return       double                               not null default 0.0 comment '因子赢家组合年化平均收益',
    win_excess_return       double                               not null default 0.0 comment '因子赢家组合超额收益(年化)',
    loss_total_return       double                               not null default 0.0 comment '因子输家组合累积收益',
    loss_annual_return      double                               not null default 0.0 comment '因子输家组合年化平均收益',
    loss_excess_return      double                               not null default 0.0 comment '因子输家组合超额收益(年化)',
    win_prob                double                               not null default 0.0 comment '因子赢家组合跑赢概率',
    loss_prob               double                               not null default 0.0 comment '因子输家组合跑输概率',
    factor_ic               double                               not null default 0.0 comment '年化平均收益与因子的相关性IC(信息比率)',
    is_valid                int                                  not null default 1 comment '因子是否有效,0-无效,1-有效',
