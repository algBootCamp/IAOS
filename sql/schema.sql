...
insert into factor_type (factor_type_id,factor_type,memo) values ('V_F','估值因子','估值因子类型因子');
commit ;
insert into factor_type (factor_type_id,factor_type,memo) values ('G_F','成长因子','成长因子类型因子');
commit ;
insert into factor_type (factor_type_id,factor_type,memo) values ('CS_F','资本结构因子','资本结构因子类型因子');
commit ;
insert into factor_type (factor_type_id,factor_type,memo) values ('T_F','技术面因子','技术面因子类型因子');
commit ;
insert into factor_type (factor_type_id,factor_type,memo) values ('SD_F','自定义因子','自定义因子类型因子');
commit ;
