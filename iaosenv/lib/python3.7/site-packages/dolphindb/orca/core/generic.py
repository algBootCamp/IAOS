...
def read_csv(path, sep=',', delimiter=None, names=None,  index_col=None,
             engine='dolphindbmoudle', usecols=None, squeeze=False, prefix=None, dtype=None,
    ...
    :param engine:
             {{'c', 'python','dolphindbmoudle'}}, optional
    ...
    elif engine != 'dolphindbmoudle':
        raise ValueError(f'Unknown engine: {engine} (valid options are "c", "python", or "dolphindbmoudle")')
    ...
    if delimiter is not None:
        if len(delimiter) > 1:
            raise ValueError("'dolphindbmoudle' engine only supports char type.")
    else:
        delimiter = ','
    ...
    # dolphindbmoudle will set the char to int8, set the right dtype
